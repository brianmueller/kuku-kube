...
function touchEnded() {
    if (
        // touchX > 100 * randCol + 5 && 
        // touchX < 100 * randCol + 95 && 
        // touchY > 100 * randRow + 5 && 
        // touchY < 100 * randRow + 95

        touchX > width / 6 * randCol + width / 120 &&
        touchX < width / 6 * randCol + width / 120 + width / 6 - width / 60 &&
        touchY > width / 6 * randRow + width / 120 &&
        touchY < width / 6 * randRow + width / 120 + width / 6 - width / 60
